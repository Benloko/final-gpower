    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8 text-center">
                <h1 class="fw-bold mb-3 text-dark" style="font-size: 2.5rem;">Bienvenue chez Gpower</h1>
                <p class="text-muted mb-4 lead">Solutions d'énergie haut de gamme.<br>Qualité et fiabilité garanties.</p>
...
<section class="py-4 bg-transparent" id="products">
    <div class="container">
        <div class="d-flex justify-content-between align-items-center mb-3">
            <h4 class="fw-bold mb-0">Nos Produits</h4>
        </div>
        ...
        <div class="text-center py-5">
            <p class="text-muted small">Aucun produit trouvé.</p>
            <?php if(isset($_GET['search'])): ?>
                <a href="<?php echo BASE_URL; ?>/" class="btn btn-sm btn-outline-primary rounded-pill">Effacer la recherche</a>
            <?php endif; ?>
        </div>
        <?php endif; ?>
