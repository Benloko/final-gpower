    ...
    <div class="row">
        ...
        <div class="col-md-9">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2 class="fw-bold mb-0">Tous les produits</h2>
            </div>
                            ...
                            <a href="<?php echo BASE_URL; ?>/product-details.php?id=<?php echo $product['id']; ?>" class="d-block h-100 text-decoration-none">
                                ...
                                <?php else: ?>
                                    <div class="d-flex flex-column align-items-center justify-content-center h-100 bg-light rounded-3 text-muted">
                                        ...
                                        <span class="small" style="font-size: 0.7rem;">Pas d'image</span>
                                    </div>
                                <?php endif; ?>
                            </a>
                        </div>
            ...
            <div class="text-center py-5">
                ...
                <p class="text-muted small">Essayez d'ajuster votre recherche ou vos filtres pour trouver ce que vous cherchez.</p>
                <a href="<?php echo BASE_URL; ?>/products.php" class="btn btn-primary rounded-pill px-4 mt-2">Effacer les filtres</a>
            </div>
            <?php endif; ?>
